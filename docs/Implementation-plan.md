...
### Tasks
- [x] Create LLM classifier module (`src/classify.py`).
- [x] Formulate structured prompt targeting Groq / Llama 3 / Gemini:
...
- [x] Read captured items from `raw/`, send payloads to LLM, and write structured Markdown files with YAML frontmatter to `wiki/{category}/{slug}.md`.
